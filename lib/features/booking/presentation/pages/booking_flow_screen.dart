...
IconData _iconFor(ServiceCatalogItem item) {
  switch (item.id) {
    case 'svc_elder_companionship':
      return Icons.elderly;
    case 'svc_non_medical_care':
      return Icons.accessible;
    case 'svc_babysitting':
      return Icons.child_care;
    case 'svc_homework_support':
      return Icons.school;
    case 'svc_kitchen_helper':
      return Icons.kitchen;
    case 'svc_laundry_helper':
      return Icons.local_laundry_service;
    case 'svc_grocery_helper':
      return Icons.shopping_cart;
    case 'svc_house_sitting':
      return Icons.house;
    case 'svc_pet_sitting':
      return Icons.pets;
    case 'svc_household_support':
...
Color _tierColour(MinTierRequired t) {
  switch (t) {
    case MinTierRequired.green:
      return const Color(0xFF22C55E);
    case MinTierRequired.blue:
      return const Color(0xFF3B82F6);
    case MinTierRequired.gold:
      return const Color(0xFFF59E0B);
    case MinTierRequired.partner:
...
class _BookingFlowScreenState extends State<BookingFlowScreen> {
  ...
  static const _totalSteps =
      7; // 0-service 1-datetime 2-duration 3-recurrence 4-address 5-prefs 6-review
  ...
  bool get _canAdvance {
    switch (_step) {
      ...
      case 4:
        return _draft.houseNumber.isNotEmpty; // address step
      default:
        return true;
    }
  }
      ...
      child: BlocConsumer<BookingBloc, BookingState>(
        listener: (ctx, state) {
          if (state is BookingCreated) {
            ctx.push('/customer/booking-confirm', extra: state.booking);
          ...
          body: Column(
            children: [
              ...
              if (_step < _totalSteps - 1 &&
                  _step != 4) // address (4) has its own button
                Padding(
    ...
    switch (_step) {
      ...
      case 3:
        return _RecurrenceStep(
          ...
          onEndDateChanged: (d) => setState(() => _draft.recurrenceEndDate = d),
        );
      case 4:
        return _AddressStep(
...
class _DateTimeStep extends StatelessWidget {
  ...
  static const _opts = [
    ...
    (
      'Flexible ±2h',
      'Worker arrives within 2 h of chosen time',
      TimeFlexibility.plusMinus2h,
    ),
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text(
            'These preferences are optional — they help us match you better.',
            style: Theme.of(
              context,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'For recurring bookings, try to assign the same worker each time.',
                      style: Theme.of(context).textTheme.bodySmall,
                    ),
                  ],
                ),
...
class _ReviewStep extends StatelessWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
              ...
              builder: (ctx, snap) {
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ok ? Icons.account_balance_wallet : Icons.warning_amber,
                        color: color,
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Available: LKR ${available.toStringAsFixed(0)}  ·  Required: LKR ${price.toStringAsFixed(0)}',
          ...
          Center(
            child: Text(
              'Funds are held in escrow until service is complete.',
              style: Theme.of(context).textTheme.bodySmall,
      ...
      child: Column(
        children: [
          ...
          _rRow(
            ...
            Icons.access_time,
            'Time',
            _timeLabel(draft.timeFlexibility, draft.exactStartTime),
          ),
          _rRow(
            context,
          ...
          _rRow(
            ...
            Icons.repeat,
            'Repeat',
            _recurrLabel(draft.recurrence),
          ),
          _rRow(
            context,
            Icons.location_on_outlined,
            'Address',
            '${draft.houseNumber}, ${draft.city}',
          ),
          _rRow(
            context,
            Icons.person_search,
  ...
  static String _timeLabel(TimeFlexibility f, String? exact) {
    switch (f) {
      ...
      case TimeFlexibility.plusMinus2h:
        return 'Flexible ±2 hours';
      case TimeFlexibility.exact:
        return exact ?? '09:00';
    }
  }
  ...
  static String _prefLabel(_BookingDraft d) {
    ...
    if (d.languagePref != LanguagePref.any) {
      parts.add(
        d.languagePref.name[0].toUpperCase() + d.languagePref.name.substring(1),
      );
    }
