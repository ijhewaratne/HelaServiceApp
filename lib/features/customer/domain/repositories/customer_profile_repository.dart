...
abstract class CustomerProfileRepository {
  ...
  Future<Either<Failure, CustomerProfile>> createProfile(CustomerProfile profile);
  Future<Either<Failure, CustomerProfile>> updateProfile(CustomerProfile profile);
