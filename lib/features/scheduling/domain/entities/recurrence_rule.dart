...
enum TimeFlexibility { exact, plusMinus2h, morningAny, afternoonAny, eveningAny }
...
class RecurrenceRule extends Equatable {
  ...
  static const RecurrenceRule once = RecurrenceRule(pattern: RecurrencePattern.once);
  ...
  int get intervalDays {
    switch (pattern) {
      case RecurrencePattern.weekly:    return 7;
      case RecurrencePattern.biweekly:  return 14;
      case RecurrencePattern.monthly:   return 30;
      case RecurrencePattern.once:      return 0;
    }
  }
  ...
  List<Object?> get props =>
      [pattern, endDate, maxOccurrences, timeFlexibility, parentBookingId];
}
