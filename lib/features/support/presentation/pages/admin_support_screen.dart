...
class _AdminSupportScreenState extends State<AdminSupportScreen> {
  ...
  void _load() {
    _future = sl<SupportRepository>().getAllOpenTickets().then(
      (r) => r.fold((_) => <SupportTicket>[], (t) => t),
    );
  }
...
class _AdminTicketCard extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Customer: ${ticket.customerId.substring(0, 8)}…',
              ...
              children: [
                Expanded(
                  child: OutlinedButton(
                    onPressed: () =>
                        _showResponseDialog(context, TicketStatus.inProgress),
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    onPressed: () =>
                        _showResponseDialog(context, TicketStatus.resolved),
                    child: const Text(
                      'Resolve',
  ...
  void _showResponseDialog(BuildContext context, TicketStatus newStatus) {
