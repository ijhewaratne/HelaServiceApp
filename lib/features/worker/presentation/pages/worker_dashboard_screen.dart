            ...
            onPressed: () async {
              ...
              if (_workerId != null) {
                await sl<FirebaseFirestore>().collection('safety_alerts').add({
                  ...
                  'severity': 'critical',
                  'message':
                      'Worker triggered the SOS button from the dashboard.',
                  'status': 'open',
        ...
        headerSliverBuilder: (_, scrolled) => [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Header(isOnline: _isOnline, onToggle: _toggleOnline),
            ),
            actions: [
              IconButton(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      'LKR ${((booking.finalPrice ?? booking.estimatedPrice) * 0.8).toStringAsFixed(0)}',
            ...
            children: [
              ...
              if (docs.isEmpty)
                ...
                ...docs.map((d) {
                  ...
                  final w =
                      (booking.finalPrice ?? booking.estimatedPrice) * 0.8;
                  return Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          _TimeChip(
                            ...
                            onChanged: (t) =>
                                setState(() => _schedule[d]![si].start = t),
                          ),
                          const Padding(
                          ...
                          _TimeChip(
                            value: slots[si].end,
                            onChanged: (t) =>
                                setState(() => _schedule[d]![si].end = t),
                          ),
                          const Spacer(),
                          InkWell(
                            onTap: () =>
                                setState(() => _schedule[d]!.removeAt(si)),
                            child: const Icon(
