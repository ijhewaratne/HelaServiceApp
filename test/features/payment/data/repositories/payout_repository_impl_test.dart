...
void main() {
  ...
  group('generateWeeklyPayouts', () {
    ...
    test(
      'groups multiple unpaid bookings for the same worker into one payout',
      () async {
  ...
  group('getWorkerPayouts', () {
    test(
      'returns only the requested worker\'s payouts, newest first',
      () async {
        ...
        result.fold((_) => fail('Expected payouts for worker_1'), (payouts) {
